...
|------|------|
| 作成日 | 2026-07-16 |
| 最終更新 | 2026-07-20（v0.9.1 = #18 公開後） |
| 現状 | **v0.9.1**・**17 ツール**（3 tier）・npm 公開済み。本書の未処理タスクは次メジャーでの `validate_*` 削除のみ |
...
| **次の最優先** | なし。**#18（R-5 の本解決）は v0.9.1 で公開済み**。以降は family の進行順に従う（**④ Skill の見直し + 実連携**へ） |
